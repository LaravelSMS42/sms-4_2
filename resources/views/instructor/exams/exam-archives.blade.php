        ...
        <tbody class="table-group-divider">
            ...
            <tr>
                ...
                <td class="d-flex justify-content-end">
                    <form action="{{ route('unarchive-exam', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to restore this exam? You may view this in the exam management page.')">
                    @csrf
                    @method('PUT')
            ...
            @empty
            <tr>
                <th>There are no archived exams</th>
            </tr>
            @endforelse
        </tbody>
    </table>
