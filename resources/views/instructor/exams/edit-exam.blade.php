...
@section('content')
    <div class="card">
        <div class="card-header text-center">
            <h5 class="card-title">Edit {{ $exam->title }}</h5>
        </div>
        <form action="{{ route('exams.update', $exam->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="instructions" name="instructions" rows='3'>{{ $exam->instructions }}</textarea>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="points" name="points" value="{{ $exam->points }}">
                ...
                <div class="form-group col d-flex h-25">
                    <div class="d-flex m-2 flex-fill">
                        ...
                        <input type="datetime-local" id="deadline_date" name="deadline_date" value="{{ date('Y-m-d\TH:i', strtotime($exam->deadline_date)) }}">
                    ...
                    <div class="d-flex m-2 flex-fill">
                        ...
                        <input type="datetime-local" id="available_date" name="available_date" value="{{ date('Y-m-d\TH:i', strtotime($exam->available_date)) }}">
                    ...
                    <div class="d-flex m-2 flex-fill">
                        ...
                        <input class="form-check-input" type="checkbox" id="allow_attachments" name="allow_attachments" {{ $exam->allow_attachments == 1 ? 'checked' : '' }}>
                    </div>
                </div>
            </div>
            <div class="card-footer">
                <div class="d-flex justify-content-between">
                    <div>
                        <a href="{{ route('exam-questions', $exam->id) }}" class="btn btn-primary">Questions</a>
                    </div>
                    <div class="gap-2 d-flex justify-content-end">
                        <button type="submit" class="btn btn-success" value="Add">Save</button>
                        <a href="{{ route('exams.index') }}" class="btn btn-danger">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
