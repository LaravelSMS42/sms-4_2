...
@section('content')
    <div class="card">
        <div class="card-header text-center">
            <h5 class="card-title">Edit {{ $assignment->title }}</h5>
        </div>
        <form action="{{ route('assignments.update', $assignment->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="instructions" name="instructions" rows='3'>{{ $assignment->instructions }}</textarea>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="points" name="points" value="{{ $assignment->points }}">
                ...
                <div class="form-group col d-flex h-25">
                    <div class="d-flex m-2 flex-fill">
                        ...
                        <input type="datetime-local" id="deadline_date" name="deadline_date" value="{{ date('Y-m-d\TH:i', strtotime($assignment->deadline_date)) }}">
                    ...
                    <div class="d-flex m-2 flex-fill">
                        ...
                        <input type="datetime-local" id="available_date" name="available_date" value="{{ date('Y-m-d\TH:i', strtotime($assignment->available_date)) }}">
                    ...
                    <div class="d-flex m-2 flex-fill">
                        ...
                        <input class="form-check-input" type="checkbox" id="allow_attachments" name="allow_attachments" {{ $assignment->allow_attachments == 1 ? 'checked' : '' }}>
                    </div>
                </div>
            </div>
